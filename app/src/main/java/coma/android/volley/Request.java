...
public abstract class Request<T> implements Comparable<Request<T>> {
     ...
     */
    @Deprecated
    public Request(String url, com.android.volley.Response.ErrorListener listener) {
     ...
     */
    public Request(int method, String url, com.android.volley.Response.ErrorListener listener) {
        mMethod = method;
        mUrl = url;
     ...
     * @return This Request object to allow for chaining.
     */
    public Request<?> setRetryPolicy(com.android.volley.RetryPolicy retryPolicy) {
